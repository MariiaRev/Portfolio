...
print()
DifferentialEvol(1, 1, a1, b1)
print()
print(" "*14, "$"*7, "АЛГОРИТМ ЗУПИНКИ 2", "$"*7)
print()
DifferentialEvol(2, 1, a1, b1)
print()
print(" "*14, "$"*7, "АЛГОРИТМ ЗУПИНКИ 3", "$"*7)
print()
DifferentialEvol(3, 1, a1, b1)
print()
...
print()
DifferentialEvol(1, 2, a2, b2)
print()
print(" "*14, "$"*7, "АЛГОРИТМ ЗУПИНКИ 2", "$"*7)
print()
DifferentialEvol(2, 2, a2, b2)
print()
print(" "*14, "$"*7, "АЛГОРИТМ ЗУПИНКИ 3", "$"*7)
print()
DifferentialEvol(3, 2, a2, b2)
print()
...
print(" "*14, "$"*7, "АЛГОРИТМ ЗУПИНКИ 1", "$"*7)
print()
DifferentialEvol(1, 3, a3, b3)
print()

print(" "*14, "$"*7, "АЛГОРИТМ ЗУПИНКИ 2", "$"*7)
print()
DifferentialEvol(2, 3, a3, b3)
print()
print(" "*14, "$"*7, "АЛГОРИТМ ЗУПИНКИ 3", "$"*7)
print()
DifferentialEvol(3, 3, a3, b3)
